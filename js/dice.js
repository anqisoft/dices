...
class DiceFaceSubClass extends DiceBase {
    drawGraphs() {
...
class DiceGenerator {
    ...
    create({ id, diceKind, sideLength: SIDE_LENGTH, contents: CONTENTS, outerLineStyle: OUTER_LINE_STYLE, innerLineStyle: INNER_LINE_STYLE, textStyle: TEXT_STYLE, options: OPTIONS }) {
        ...
        switch(diceKind){
            case DiceKind.four:
                new DiceFace4(svg, FIXED_SIDE_LENGTH, INNER_LINE_STYLE, OUTER_LINE_STYLE, viewBox, OPTIONS, mmToPxScale, infos, CONTENTS).draw();
                break;
            case DiceKind.six:
                new DiceFace6(svg, FIXED_SIDE_LENGTH, INNER_LINE_STYLE, OUTER_LINE_STYLE, viewBox, OPTIONS, mmToPxScale, infos, CONTENTS).draw();
                break;
            case DiceKind.eight:
                new DiceFace8(svg, FIXED_SIDE_LENGTH, INNER_LINE_STYLE, OUTER_LINE_STYLE, viewBox, OPTIONS, mmToPxScale, infos, CONTENTS).draw();
                break;
            case DiceKind.twelve:
                new DiceFace12(svg, FIXED_SIDE_LENGTH, INNER_LINE_STYLE, OUTER_LINE_STYLE, viewBox, OPTIONS, mmToPxScale, infos, CONTENTS).draw();
                break;
            case DiceKind.twenty:
                new DiceFace20(svg, FIXED_SIDE_LENGTH, INNER_LINE_STYLE, OUTER_LINE_STYLE, viewBox, OPTIONS, mmToPxScale, infos, CONTENTS).draw();
                break;
            case DiceKind.twentyFour:
                new DiceFaceSubClass(svg, FIXED_SIDE_LENGTH, INNER_LINE_STYLE, OUTER_LINE_STYLE, viewBox, OPTIONS, mmToPxScale, infos, CONTENTS).draw();
                break;
            default:
                break;
        }
...
export { DiceGenerator as DiceGenerator };

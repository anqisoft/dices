...
var edu1;
const { getHtmlElement } = __default3;
(function(edu) {
    let sonya;
    (function(sonya) {
        let cc;
...
const { getCurrentLang } = __default1;
var edu2;
(function(edu1) {
    let sonya;
    (function(sonya) {
        ...
        (function(cc) {
            ...
            class SvgHelper {
                ...
                static appendOuterPath(svg, WIDTH, HEIGHT, mmToPxScale, OUTER_LINE_COLOR) {
                    ...
                    const path = edu2.sonya.cc.SvgHelper.createSvgPath();
                ...
                static appendOuterLine(svg, WIDTH, HEIGHT, OUTER_LINE_STYLE) {
                    svg.setAttribute("width", `${WIDTH}mm`);
                    svg.setAttribute("height", `${HEIGHT}mm`);
                    const { appendLine } = edu2.sonya.cc.SvgHelper;

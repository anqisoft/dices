...
const { getHtmlElement } = __default1;
var edu2;
(function(edu) {
    let sonya;
    (function(sonya) {
...
const { getCurrentLang } = __default2;
var edu3;
(function(edu1) {
    let sonya;
    (function(sonya) {
        ...
        (function(cc) {
            ...
            class SvgHelper {
                ...
                static appendOuterPath(svg, WIDTH, HEIGHT, mmToPxScale, OUTER_LINE_COLOR) {
                    ...
                    const path = edu3.sonya.cc.SvgHelper.createSvgPath();
                ...
                static appendOuterLine(svg, WIDTH, HEIGHT, OUTER_LINE_STYLE) {
                    svg.setAttribute("width", `${WIDTH}mm`);
                    svg.setAttribute("height", `${HEIGHT}mm`);
                    const { appendLine } = edu3.sonya.cc.SvgHelper;

import { I18nable, SvgHelper } from '../node_modules/@dishanqian/h5_base/types/index.d.ts';
export default abstract class DiceBase {
    ...
    draw(): void;
    protected setSvgTextInfo: typeof SvgHelper.setSvgTextInfo;
    protected appendLine: typeof SvgHelper.appendLine;
    protected appendCircle: typeof SvgHelper.appendCircle;
